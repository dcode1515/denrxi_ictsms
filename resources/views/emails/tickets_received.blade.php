            ...
            <table width="600" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td style="padding:25px; color:#333333; font-size:14px; line-height:1.6;">
                        ...
                        <!-- Status -->
                        <p>
                            We would like to inform you that your helpdesk ticket has been
                            <strong>successfully received</strong> and is now marked as
                            <strong style="color:#0b5ed7;">{{ $ticket->status }}</strong>.
                        </p>
                        ...
                        <table width="100%" cellpadding="8" cellspacing="0"
                            ...
                            <tr>
                             ...
                             <tr>
                                <td width="35%"><strong>Subject:</strong></td>
                                 <td>{{ $ticket->ticketCategory->ticket_category }}</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ \Carbon\Carbon::parse($ticket->date_receive)->format('F d, Y \a\t g:i A l') }}
                                </td>
                            </tr>
                            <tr>
                        ...
                        <ul style="padding-left:20px; margin-top:0;">
                            <li>Our technician will review your concern within 24 hours.</li>
                            <li>You will receive updates via email or phone call.</li>
                            <li>Complex issues may require additional time for resolution.</li>
                        ...
                        <!-- Closing -->
                        <p>
                            Our assigned technician is currently reviewing your concern.
                            You will receive updates as soon as there is progress on your request.
                        </p>

                        <p>
                            If you have additional information related to this concern,
