...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>DENR XI | ICT Service Mangement System</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
    ...
    <!--! BEGIN: Bootstrap CSS-->
     ...
     <link rel="stylesheet" href="{{ URL::asset('public/Duralux-admin-1.0.0/assets/css/bootstrap.min.css') }}">
    <!--! END: Bootstrap CSS-->
    <!--! BEGIN: Vendors CSS-->
     <link rel="stylesheet" href="{{ URL::asset('public/Duralux-admin-1.0.0/assets/vendors/css/vendors.min.css') }}">
     <link rel="stylesheet" href="{{ URL::asset('public/Duralux-admin-1.0.0/assets/vendors/css/daterangepicker.min.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('public/Duralux-admin-1.0.0/assets/css/theme.min.css') }}">
  </head>
...
/* Hide small logo on mobile/tablet */
@media (max-width: 768px) {
    ...
    .b-brand {
        font-size: 0; /* Hide text but keep logos */
    }
...
<body>
    ...
    <script src="{{ asset('public/Duralux-admin-1.0.0/assets/vendors/js/vendors.min.js') }}"></script>
    <script src="{{ asset('public/Duralux-admin-1.0.0/assets/vendors/js/daterangepicker.min.js') }}"></script>
    <script src="{{ asset('public/Duralux-admin-1.0.0/assets/vendors/js/apexcharts.min.js') }}"></script>
    <script src="{{ asset('public/Duralux-admin-1.0.0/assets/vendors/js/circle-progress.min.js') }}"></script>
    <script src="{{ asset('public/Duralux-admin-1.0.0/assets/js/common-init.min.js') }}"></script>
    <script src="{{ asset('public/Duralux-admin-1.0.0/assets/js/dashboard-init.min.js') }}"></script>
    <script src="{{ asset('public/Duralux-admin-1.0.0/assets/js/theme-customizer-init.min.js') }}"></script>
    <!-- Add these to your index.html or layout file -->
